...
{
private:
	PxPhysics		*m_pPhysics;	// pointer to the novodex engine
	PxFoundation	*m_pFoundation;
	PxScene			*m_pScene;		// pointer to world scene
	...
	PxTriangleMesh	*m_pSceneMesh;
	PxActor			*m_pSceneActor;	// scene with installed shape
...
private:
	...
	PxConvexMesh	*ConvexMeshFromBmodel( entvars_t *pev, int modelindex );
	PxConvexMesh	*ConvexMeshFromStudio( entvars_t *pev, int modelindex );
	PxConvexMesh	*ConvexMeshFromEntity( CBaseEntity *pObject );
	PxTriangleMesh	*TriangleMeshFromBmodel( entvars_t *pev, int modelindex );
	PxTriangleMesh	*TriangleMeshFromStudio( entvars_t *pev, int modelindex );
	PxTriangleMesh	*TriangleMeshFromEntity( CBaseEntity *pObject );
	PxActor		*ActorFromEntity( CBaseEntity *pObject );
	CBaseEntity	*EntityFromActor( PxActor *pObject );
